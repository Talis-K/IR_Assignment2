...
class Load(DHRobot3D):
    def __init__(self):
        ...
        qtest_transforms = [
            ...
            spb.transl(0, 0, 0.09) @ spb.trotz(0) @ spb.trotx(0),  # Joint_a2
            spb.transl(0, -0.014, 0.31) @ spb.trotz(0) @ spb.trotx(0),  # Joint_a3
            spb.transl(0, -0.014, 0.49) @ spb.trotz(0) @ spb.trotx(0),  # Joint_a4
            spb.transl(0, 0, 0.701) @ spb.trotz(0) @ spb.trotx(0),  # Joint_a5
            spb.transl(0, 0, 0.878) @ spb.trotz(0) @ spb.trotx(0),  # Joint_a6
            spb.transl(0, 0, 1.078) @ spb.trotz(0) @ spb.trotx(0),  # Joint_a7
            spb.transl(0, 0, 1.078) @ spb.trotz(0) @ spb.trotx(0),  # ee
